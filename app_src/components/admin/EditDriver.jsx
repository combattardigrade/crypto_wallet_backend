                                ...
                                <div className="card-body">
                                    <div className="card-body">
                                        ...
                                        <form className="forms-sample">
                                            ...
                                            <DropZone />
                                            <button type="submit" className="btn btn-primary mr-2">Actualizar Usuario</button>
                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <form className="forms-sample">
                                        ...
                                        <button type="submit" className="btn btn-primary mr-2">Actualizar Contraseña</button>
                                        <button className="btn btn-light">Cancelar</button>
                                    </form>
                                </div>
                            </div>
